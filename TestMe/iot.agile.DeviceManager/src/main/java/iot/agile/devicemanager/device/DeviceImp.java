...
import iot.agile.devicemanager.device.protocol.BLEProtocol;
...
public class DeviceImp implements Device {
	...
	public DeviceImp(String deviceID, String deviceName, String protocol) {
		...
		try {
			DBusConnection newDeviceDbusObject = DBusConnection.getConnection(DBusConnection.SESSION);
			newDeviceDbusObject.requestBusName(deviceAgileID);
			newDeviceDbusObject.exportObject(devicePath, new DeviceImp(deviceID, deviceName, deviceAgileID, protocol));
	 ...
	 * 
	 */
	public DeviceImp(String deviceID, String deviceName, String deviceAgileID, String protocol) {
		this.deviceID = deviceID;
		this.deviceName = deviceName;
		this.deviceAgileID = deviceAgileID;
		this.protocol = protocol;
	}
