#!/bin/sh
ssh agilepi1 -c 'mkdir agilepi1:~/git/agile-core/iot.agile.ProtocolManager/target'
ssh agilepi1 -c 'mkdir agilepi1:~/git/agile-core/iot.agile.DeviceManager/target'
ssh agilepi1 -c 'mkdir agilepi1:~/git/agile-core/iot.agile.DeviceFactory/target'
ssh agilepi1 -c 'mkdir agilepi1:~/git/agile-core/iot.agile.http/target'
